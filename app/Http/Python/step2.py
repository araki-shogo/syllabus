...
# 画像読み込み
img = cv2.imread("step1out/jikanwari_syllabus_01.jpeg")
...
def trim():
    ...
    if debug1:
        ...
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+".jpg", img1)
        pass
    lef = 516
    wid = 1035
    if debug2:
        ...
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+"_1"+".jpg", img1_1)
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+"_2"+".jpg", img1_2)
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+"_3"+".jpg", img1_3)
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+"_4"+".jpg", img1_4)
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+"_5"+".jpg", img1_5)
        cv2.imwrite("./step2out/out_sample_"+str(num).zfill(4)+"_6"+".jpg", img1_6)
        pass
    if debug3:
        s = "./step2out/out_sample_"+str(num).zfill(4)
